  ...
  return (
    <Container className='footer shadow' maxWidth='md' sx={{ boxShadow: 20}}>
      ...
      <Box className='' sx={{ py: 3}}>
        ...
        <Link to='mailto: nereida.rondon5@gmail.com' target='_blank'><AlternateEmailIcon sx={{ fontSize: 50, mx: 5 }} color="secondary"/></Link>
    
        <Link to='https://www.linkedin.com/in/nereidarondon/' target='_blank'><LinkedInIcon sx={{ fontSize: 50, mx: 5 }} color="info"/></Link>
        
        <Link to='https://github.com/NereidaRondon' target='_blank'><GitHubIcon sx={{ fontSize: 50, mx: 5, color: pink[200] }} /></Link>

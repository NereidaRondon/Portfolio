      ...
      <Box sx={{ flexGrow: 1 }}>
        ...
        <Grid className='m-0' container spacing={{ xs: 3, sm: 6 }} columns={{ xs: 12, lg: 6}}>
          ...
          <Grid item xs={12} lg={6}>
            <iframe className='video' width="560" height="315" src="https://www.youtube.com/embed/yKwq6Ai6skI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          </Grid>

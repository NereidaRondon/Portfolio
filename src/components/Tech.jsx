      ...
      <Container className='' ref={refTech} maxWidth="lg" sx={{pt:15, pb:10}} >
        <Container className='skills--wrapper' maxWidth="lg" sx={{p:2}} 
          ...
          <Container className='skills--container' maxWidth="lg" sx={{display: 'flex', py:4}}>   
            ...
            <Box className='skill' sx={{m:2 }}><a  href="https://git-scm.com/" target="_blank" rel="noreferrer"><img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/git-colored.svg" width="60" height="60" alt="Git" /></a></Box>

            <Box className='skill' sx={{m:2 }}><a  href="https://developer.mozilla.org/en-US/docs/Glossary/HTML5" target="_blank" rel="noreferrer"><img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/html5-colored.svg" width="60" height="60" alt="HTML5" /></a></Box>

            <Box className='skill' sx={{m:2 }}><a  href="https://www.w3.org/TR/CSS/#css" target="_blank" rel="noreferrer"><img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/css3-colored.svg" width="60" height="60" alt="CSS3" /></a></Box>
